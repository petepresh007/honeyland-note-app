...
import { userUrl, url } from "../server";
...
export const UpdatePics = () => {
    ...
    async function updateFile(e) {
        ...
        try {
            const { data } = await axios.patch(`${userUrl}/updateprofilepics`, profilePics)
            //alert(data.msg);
    ...
    async function changePassword(e) {
        e.preventDefault();
        try {
            const { data } = await axios.patch(`${userUrl}/password`, { password, newpassword, confirmpassword });
            //alert(data.msg)
            toast.success(data.msg)
